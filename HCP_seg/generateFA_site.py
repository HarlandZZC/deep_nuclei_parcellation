...
# python /home/haolin/Research/HCP_seg/generateFA_site.py --folder folder --flip 1
...
def process_subfolder(subfolder_path):
    ...
    for ses_folder in ses_folders:
        ...
        for dwi_file in dwi_files:
            ...
            DDSurfer_output_folder = os.path.join(subfolder_path, f'{ses_folder}/dwi/FA/{subID}')
            print("Target folder path:", DDSurfer_output_folder)
            
            # 生成命令行
            command = [
                "bash",
                "/home/haolin/Research/HCP_seg/FA.sh",
                "--dwi", dwi_path,
                "--bval", bval_path,
                "--bvec", bvec_path,
                "--mask", mask_path,
