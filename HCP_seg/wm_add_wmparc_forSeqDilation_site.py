...
# python /home/haolin/Research/HCP_seg/wm_add_wmparc_forSeqDilation_site.py --SiteFolder folder1 --TractFolder folder2 --num_workers 20
...
def process_subfolder(subfolder_path):
    ...
    print(f"----- WM add wmparc (for SeqDilation) for {subfolder_name} -----") 
    ...
    for ses_folder in ses_folders:
        ...
        for sb_DS_folder in sb_DS_folders:
            ...
            output_path = os.path.join(subfolder_path, f'{ses_folder}/dwi/WMadded/{sb_DS_folder}/{sb_DS_folder}-WMadded-SeqDilation.vtk')
