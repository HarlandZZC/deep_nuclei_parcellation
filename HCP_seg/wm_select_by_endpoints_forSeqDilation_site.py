...
# python /home/haolin/Research/HCP_seg/wm_select_by_endpoints_forSeqDilation_site.py --folder folder --num_workers 1
...
# 清空日志文件夹
txt_path = "/home/haolin/Research/HCP_seg/missing_labels_inselect_forSeqDilation.txt"
...
def process_subfolder(subfolder_path):
    ...
    print(f"----- WM select by endpoints (forSeqDilation) for {subfolder_name} -----") 
    ...
    for ses_folder in ses_folders:
        ...
        for sb_DS_folder in sb_DS_folders:
            ...
            tract_file = sb_DS_folder + '-WMadded-SeqDilation.vtk'
            ...
            output_path = os.path.join(subfolder_path, f'{ses_folder}/dwi/selected_by_endpoints/', sb_DS_folder + '-SeqDilation')
...
def find_other_labels(sb_DS_folder, data, target_label1, target_label2):
    ...
    try:
        ...
        with open("/home/haolin/Research/HCP_seg/missing_labels_inselect_forSeqDilation.txt", "a") as file:
